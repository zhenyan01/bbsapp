...
public class CommunityIndexAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public CommunityIndexAdapter(Context context, List<Post> postList){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if(viewType == F_TYPE){
            return new CommunityIndexAdapter.RecyclerViewHolder(footView, F_TYPE);
        }else{
            return new CommunityIndexAdapter.RecyclerViewHolder(postView, P_TYPE);
        }
    }
